...
// Parte 3: Ensinando a navegar na visão interna
	"Ótimo. Agora estamos vendo o interior do gabinete.",
	"Observe os elementos da sua interface na tela. Eles te ajudarão no conserto.",
	"Use as setas de movimentação para girar a câmera e ver outros ângulos.",
	"Isso será útil para encontrar e remover cada uma das peças.",

	// Parte 4: Identificação das peças ("E assim por diante...")
	"Esta placa grande e cheia de circuitos é a Placa-Mãe.",
	"Ela é a base que conecta todos os outros componentes do computador.",
	"No centro dela, debaixo da ventoinha, fica o processador (CPU).",
	"A peça com a ventoinha é o Cooler. Ele impede que a CPU superaqueça.",
	"Veja estes 'pentes' encaixados na Placa-Mãe? São as memórias RAM.",
	"Essa placa maior, conectada mais abaixo, é a Placa de Vídeo (GPU).",
	"E a caixa de onde saem todos os cabos é a Fonte de Alimentação.",

	// Parte 5: Próximo passo
	"Agora que você conhece o básico, vamos começar nosso diagnóstico.",
	"Precisamos descobrir qual peça foi danificada pela queda de energia.",
	"Selecione a Ferramenta de Teste na sua interface para começar."
