...
if (global.state_pc == "PC"){
	...
	if (global.power.connected) {
	    ...
	    if (_hovered && _clicked && _state_dismount) { global.power.connected = false; }
	...
	if (global.board.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.board.connected = false; }
	    _list_y += _line_height;
	}
	if (global.cpu.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.cpu.connected = false; }
	    _list_y += _line_height;
	}
	if (global.cooler.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.cooler.connected = false; }
	    _list_y += _line_height;
	}
	if (global.ram.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.ram.connected = false; }
	    _list_y += _line_height;
	}
	if (global.gpu.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.gpu.connected = false; }
	    _list_y += _line_height;
	}
	if (global.hd.connected) {
	    ...
	    draw_set_color(_hovered ? c_red : c_white);
	    draw_text(_list_x, _list_y, _text);
	    if (_hovered && _clicked && _state_dismount) { global.hd.connected = false; }
	    _list_y += _line_height;
	}
