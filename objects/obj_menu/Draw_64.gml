...
for (var _i = 0; _i < array_length(menu_text); _i++){
	...
	draw_text_transformed_color(_xgui, _ygui + ((_str_size_y + 2) * _i), menu_text[_i], text_escale[_i] , text_escale[_i], image_angle, text_color, text_color , text_color , text_color,image_alpha);
}
