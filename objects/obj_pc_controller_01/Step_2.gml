...
if global.state_pc == "GABINETE_LF" {
			...
			if (global.cooler.connected) {
				...
				if (global.ram.connected) {
					if (global.gpu.connected) {
						...
						else if (global.power.connected) {/* Lógica para: MB, CPU, RAM, Fonte */
							obj_gabinete.image_index = 5
							obj_gabinete_aux.image_index = 2
							}
						else if (global.hd.connected) {
	...
	// --- CENÁRIO 2: Placa-mãe NÃO está no gabinete ---
		...
		if (global.power.connected and global.hd.connected and global.gpu.connected and global.ram.connected) {
			/* Lógica para: Fonte, HD, GPU e RAM soltos */
			
			
			}
		else if (global.power.connected and global.hd.connected and global.gpu.connected) { 
			/* Lógica para: Fonte, HD e GPU soltos */ 
			
			
			}
		else if (global.power.connected and global.hd.connected and global.ram.connected) { 
			/* Lógica para: Fonte, HD e RAM soltos */ 
			
			
			}
		else if (global.power.connected and global.gpu.connected and global.ram.connected) {
			/* Lógica para: Fonte, GPU e RAM soltos */ 
			
			
			}
		else if (global.hd.connected and global.gpu.connected and global.ram.connected) { 
			/* Lógica para: HD, GPU e RAM soltos */ 
			
			
			}
		else if (global.power.connected and global.hd.connected) { 
			/* Lógica para: Fonte e HD soltos */
			obj_gabinete.image_index = 0
			obj_gabinete_aux.image_index = 8
			}
		else if (global.power.connected and global.gpu.connected) { 
			/* Lógica para: Fonte e GPU soltas */
			
			
			}
		else if (global.power.connected and global.ram.connected) { 
			/* Lógica para: Fonte e RAM soltas */ 
			
			
			}
		else if (global.hd.connected and global.gpu.connected) { 
			/* Lógica para: HD e GPU soltos */
			
			
			}
		else if (global.hd.connected and global.ram.connected) { 
			/* Lógica para: HD e RAM soltos */
			
			
			}
		else if (global.gpu.connected and global.ram.connected) { 
		...
		else if (global.gpu.connected) {
			/* Lógica para: Apenas a GPU solta */
			
			
			}
		else if (global.ram.connected) {
